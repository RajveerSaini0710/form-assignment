export default {
  ...
  panel: ({ props }) => ({
    class: [
      ...
      "border-purple-600 dark:border-purple-700",
  ...
  header: {
    class: [
      ...
      // Colors
      "text-purple-700 dark:text-purple-800",
      "bg-purple-0 dark:bg-surface-800",
    ...
    class: [
      ...
      "focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 dark:focus:ring-primary-300/50",
      {
        "hover:bg-purple-100 dark:hover:bg-purple-200":
          !context.selected && !context.disabled,
        "hover:bg-purple-200": context.selected && !context.disabled,
      },
      {
  ...
  daylabel: ({ context }) => ({
    class: [
      ...
      // Colors
      {
        "text-purple-700 dark:text-purple-700": context.date.today,
        "text-purple-700 dark:text-purple-700 bg-transparent":
          !context.selected && !context.disabled && !context.date.today,
        "text-purple-700 bg-primary-100 dark:text-purple-700 dark:bg-primary-300/40":
          context.selected && !context.disabled,
      },
      ...
      "focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 dark:focus:ring-primary-300/50",
      {
        "hover:bg-purple-100 dark:hover:bg-purple-200":
          !context.selected && !context.disabled,
        "hover:bg-purple-200 dark:hover:bg-purple-200":
          context.selected && !context.disabled,
      },
      {
        "opacity-60 cursor-default": context.disabled,
  ...
  month: ({ context }) => ({
    class: [
      ...
      // Colors
      {
        "text-purple-600 dark:text-purple-700 bg-transparent":
          !context.selected && !context.disabled,
        "text-purple-700 bg-primary-100 dark:text-purple-700 dark:bg-primary-300/40":
          context.selected && !context.disabled,
      },
