export default {
  ...
  header: ({ props }) => ({
    class: [
      ...
      // Color
      "bg-purple-50 dark:bg-purple-800",
  ...
  column: {
    headercell: ({ context, props }) => ({
      class: [
        ...
        (props.sortable === "" || props.sortable) && context.sorted
          ? "bg-primary-50 text-purple-700"
          : "bg-surface-50 text-purple-700",
        (props.sortable === "" || props.sortable) && context.sorted
          ? "dark:text-purple-700 dark:bg-primary-400/30"
          : "dark:text-purple-700 dark:bg-surface-800",
        "border-surface-200 dark:border-surface-700 ",
    ...
    sort: ({ context }) => ({
      class: [
        context.sorted ? "text-primary-500" : "text-purple-700",
    ...
    footercell: ({ context }) => ({
      class: [
        ...
        // Color
        "border-surface-200 dark:border-surface-700",
        "text-purple-700 dark:text-white/80",
        "bg-surface-50 dark:bg-surface-800",
      ],
    }),
    sorticon: ({ context }) => ({
    ...
    filterrowitem: ({ context }) => ({
      class: [
        ...
        // Color
        { "text-purple-700 dark:text-white/80": !context?.highlighted },
        {
          "bg-surface-0 dark:bg-surface-800 text-purple-700 dark:text-white/80":
            !context?.highlighted,
        },
        {
        ...
        {
          "hover:text-purple-700 hover:bg-surface-100 dark:hover:text-white dark:hover:bg-surface-600/80":
            !context?.highlighted,
        },
        "focus-visible:outline-none focus-visible:outline-offset-0 focus-visible:ring focus-visible:ring-inset focus-visible:ring-primary-400/50 dark:focus-visible:ring-primary-300/50",
    ...
    filteroperatordropdown: {
      ...
      item: ({ context }) => ({
        class: [
          ...
          {
            "bg-surface-50 dark:bg-surface-600/60 text-purple-700 dark:text-purple-700":
              context.focused && !context.selected,
          },
          {
            "bg-primary-100 dark:bg-primary-400/40 text-purple-700 dark:text-purple-700":
              context.focused && context.selected,
          },
          {
            "bg-primary-50 dark:bg-primary-400/40 text-purple-700 dark:text-purple-700":
              !context.focused && context.selected,
          },
          ...
          {
            "hover:text-purple-700 hover:bg-surface-100 dark:hover:text-purple dark:hover:bg-surface-600/80":
              context.focused && !context.selected,
          },
    ...
    filtermenubutton: ({ context }) => ({
      class: [
        ...
        "dark:text-purple-700 dark:hover:text-white/80 dark:bg-surface-800",

        // States
        "hover:text-purple-700 hover:bg-surface-300/20",
    ...
    rowtoggler: {
      class: [
        ...
        // Color
        "text-surface-500 dark:text-purple-700",
        "bg-transparent",
    ...
    rowRadiobutton: {
      ...
      box: ({ props }) => ({
        class: [
          ...
          // Colors
          {
            "text-purple-700 dark:text-white/80": !props.modelValue,
  ...
  rowgroupheader: {
    class: [
      "sticky z-20",
      "bg-surface-0 text-surface-600 dark:text-purple-700",
      "dark:bg-surface-800",
    ],
  },
  rowgroupfooter: {
